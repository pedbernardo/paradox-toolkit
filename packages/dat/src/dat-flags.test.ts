...
describe("getDatFlags", () => {
  ...
  describe("version 772", () => {
    ...
    it("has STACKABLE at 5 (shifted from 710)", () =>
      expect(getDatFlags(772)["STACKABLE"]).toBe(5));
  ...
  describe("version 1098", () => {
    it("has NO_MOVE_ANIMATION at 16", () =>
      expect(getDatFlags(1098)["NO_MOVE_ANIMATION"]).toBe(16));
